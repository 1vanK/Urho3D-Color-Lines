...
{
    // Размер новых ячеек при их создании равен нулю, а затем в течение какого-то промежутка времени плавно возрастает до 1.0f.
    // Благодаря этому даже если новая ячейка создается в области видимости, это не выглядит как внезапное возникновение ячейки.
